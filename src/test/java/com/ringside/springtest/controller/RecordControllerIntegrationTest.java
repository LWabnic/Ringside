...
public class RecordControllerIntegrationTest {
	...
	public void createTest() throws Exception {
		...
		mvc.perform(post("/record/createR").contentType(MediaType.APPLICATION_JSON).content(entryAsJSON))
	...
	public void findByNameTest() throws Exception {
		...
		mvc.perform(get("/record/readname/Lennox Lewis")).andExpect(status().isOk()).andExpect(content().json(rAsJson));
